                ...
                displayQuotes.map((quote) => (
                  <tr key={quote.id} className="hover:bg-indigo-50/50 transition-colors duration-150">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <Link href={`/dashboard/quotes/${quote.id}`} className="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300">
                        Voir
                      </Link>
                      <Link href={`/dashboard/quotes/${quote.id}/edit`} className="text-pink-600 hover:text-pink-900 dark:text-pink-400 dark:hover:text-pink-300">
                        Modifier
                      </Link>
                    </td>
                  </tr>
