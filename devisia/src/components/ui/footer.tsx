      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <div className="font-bold text-2xl bg-gradient-to-r from-primary-400 to-secondary-400 bg-clip-text">
              Devisia
            </div>
          ...
          {/* Mentions légales */}
          <div>
            <h3 className="font-semibold text-lg mb-4">Mentions légales</h3>
            <ul className="space-y-3">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Recevez nos actualités et conseils pour optimiser votre activité.
            </p>
